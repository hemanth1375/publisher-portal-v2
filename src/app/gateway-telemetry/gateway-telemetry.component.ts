...
export class GatewayTelemetryComponent {
  ...
  ngOnInit() {
    ...
    this.TelemertyFormGroup.get("enableLogstash")?.valueChanges.subscribe((value)=>{
      if(value){
        this.TelemertyFormGroup.get("logMsgFormat")?.setValue("logstash")
      }
    })
    ...
    // const telementryBody = {}
     const telementryBody =  {
        ...
        ...(this.TelemertyFormGroup.value?.isOpenTelActive && {
          "telemetry/opentelemetry": {
            ...(this.TelemertyFormGroup.value?.OTreportingPeriod && { "metric_reporting_period": this.TelemertyFormGroup.value?.OTreportingPeriod }),
            ...(this.TelemertyFormGroup.value?.OTsampleRate && { "trace_sample_rate": this.TelemertyFormGroup.value?.OTsampleRate }),
            "exporters": {
              ...(this.TelemertyFormGroup.value?.otlp.length !== 0) && { "otlp": this.TelemertyFormGroup.value?.otlp },
              ...(this.TelemertyFormGroup.value?.prometheus.length !== 0) && { "prometheus": this.TelemertyFormGroup.value?.prometheus }
            }
          }
        }),
       ...
       ...(this.TelemertyFormGroup.get('isLoggingActive')?.value && {
         "telemetry/logging": {
           "level": this.TelemertyFormGroup.get('logginngLevel')?.value,
       ...
       "telemetry/logstash": {
         "enabled": this.TelemertyFormGroup.get("enableLogstash")?.value
       },
        ...
        ...(this.TelemertyFormGroup.value?.newRelicNativeSDKActive && {
          "telemetry/newrelic": {
            ...(this.TelemertyFormGroup.value?.newRelicSDKDebug && { "debug": this.TelemertyFormGroup.value?.newRelicSDKDebug }),
            ...(this.TelemertyFormGroup.value?.headersToPassArrayValue.length != 0 && { "headers_to_pass": this.TelemertyFormGroup.value?.headersToPassArrayValue }),
            ...(this.TelemertyFormGroup.value?.newRelicLicense && { "license": this.TelemertyFormGroup.value?.newRelicLicense })
          }
        }),
  
        ...(this.TelemertyFormGroup.value?.isMetricsAPiActive && {
          "telemetry/metrics": {
            ...(this.TelemertyFormGroup.value?.metricsDisableBackend && { "backend_disabled": this.TelemertyFormGroup.value?.metricsDisableBackend }),
            ...(this.TelemertyFormGroup.value?.metricCollecTime && { "collection_time": this.TelemertyFormGroup.value?.metricCollecTime }),
            ...(this.TelemertyFormGroup.value?.metricsDisableEndpoint && { "endpoint_disabled": this.TelemertyFormGroup.value?.metricsDisableEndpoint }),
            ...(this.TelemertyFormGroup.value?.metricsListenAddress && { "listen_address": this.TelemertyFormGroup.value?.metricsListenAddress }),
            ...(this.TelemertyFormGroup.value?.metricsDisableProxy && { "proxy_disabled": this.TelemertyFormGroup.value?.metricsDisableProxy }),
            ...(this.TelemertyFormGroup.value?.metricsDisableRouter && { "router_disabled": this.TelemertyFormGroup.value?.metricsDisableRouter })
          }
        }),
